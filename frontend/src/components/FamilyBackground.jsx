...
const FamilyBackground = () => {
  ...
  const [isSoloParent, setIsSoloParent] = useState(false); // State for checkbox
  const [parentType, setParentType] = useState(""); // State for dropdown

  // Function to handle checkbox click
  const handleCheckboxChange = () => {
    setIsSoloParent((prev) => !prev);
  };

  // Function to handle solo parent details input change
    ...
    <Container>
      ...
      <form>
        <Container maxWidth="100%" sx={{ backgroundColor: "#6D2323", color: "white", borderRadius: 2, boxShadow: 3, padding: "4px" }}>
          <Box sx={{ width: "100%" }}>
            <Typography style={{ fontSize: "15px", padding: "10px" }}>Step 2: Family Background</Typography>
          </Box>
        </Container>
        ...
        <Container maxWidth="100%" sx={{ backgroundColor: "white", padding: 4, borderRadius: 2, boxShadow: 3 }}>
            ...
            {isSoloParent && (
              <Box marginTop="10px" display="flex" alignItems="center">
                <FormControl fullWidth size="small" style={{ width: "200px", marginRight: "16px" }}>
                  <InputLabel id="parent-type-label">Parent/Mother/Father</InputLabel>
                  <Select
            ...
            <Box mt={2}>
              ...
              <div style={{ marginRight: "-40px" }}><strong><span> <br />Father's Name:</span></strong></div>
                <Box width="20%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.father_family_name}
                    onChange={(e) =>
                ...
                <Box width="20%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.father_given_name}
                    onChange={(e) =>
                ...
                <Box width="20%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.father_middle_name}
                    onChange={(e) =>
                ...
                <div>EXT: <span style={{ color: "red" }}>*</span></div>
                  <FormControl sx={{ width: "100%", }} size="small">
                    ...
                    <Select
                      ...
                      value={newFamilyBackground.father_ext || ""}
                      label="EXT."
                      onChange={(e) =>
                ...
                <Box width="20%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.father_nickname}
                    onChange={(e) =>
                ...
                {!fatherEduNotApplicable && (
                  ...
                  >
                    <TextField
                      ...
                      size="small"
                      value={newFamilyBackground.father_education_level}
                    ...
                    <TextField
                      ...
                      size="small"
                      value={newFamilyBackground.father_last_school}
                    ...
                    <TextField
                      ...
                      size="small"
                      value={newFamilyBackground.father_course}
                    ...
                    <TextField
                      ...
                      size="small"
                      value={newFamilyBackground.father_year_graduated}
                    ...
                    <TextField
                      ...
                      size="small"
                      value={newFamilyBackground.father_school_address}
              ...
              <Box display="flex" gap={2}>
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.father_contact}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.father_occupation}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.father_employer}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.father_income}
                    onChange={(e) =>
              ...
              <Box width="100%" marginTop="10px">
                ...
                <TextField
                  ...
                  style={{ width: "49.5%" }}
                  size="small"
                  value={newFamilyBackground.father_email}
                  onChange={(e) =>
            ...
            <Box mt={2}>
              ...
              <div style={{ marginRight: "-40px" }}><strong>Mother's <span> <br />Maiden Name:</span></strong></div>
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.mother_family_name}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.mother_given_name}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.mother_middle_name}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.mother_nickname}
                    onChange={(e) =>
                  ...
                  {!motherEduNotApplicable && (
                    ...
                    >
                      <TextField
                        ...
                        size="small"
                        value={newFamilyBackground.mother_education_level}
                      ...
                      <TextField
                        ...
                        size="small"
                        value={newFamilyBackground.mother_last_school}
                      ...
                      <TextField
                        ...
                        size="small"
                        value={newFamilyBackground.mother_course}
                      ...
                      <TextField
                        ...
                        size="small"
                        value={newFamilyBackground.mother_year_graduated}
                      ...
                      <TextField
                        ...
                        size="small"
                        value={newFamilyBackground.mother_school_address}
              ...
              <Box display="flex" gap={2} marginTop="10px">
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.mother_contact}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.mother_occupation}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.mother_employer}
                    onChange={(e) =>
                ...
                <Box width="25%">
                  ...
                  <TextField
                    ...
                    style={{ width: "100%" }}
                    size="small"
                    value={newFamilyBackground.mother_income}
                    onChange={(e) =>
              ...
              <Box width="100%" marginTop="10px">
                ...
                <TextField
                  ...
                  style={{ width: "49.5%" }}
                  size="small"
                  value={newFamilyBackground.mother_email}
                  onChange={(e) =>
          ...
          <Box mt={2}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px', }}>
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  value={newFamilyBackground.guardian || ""}
                  label="Guardian"
            ...
            <Box display="flex" gap={2}>
              ...
              <Box width="20%">
                ...
                <TextField
                  ...
                  style={{ width: "100%" }}
                  size="small"
                  value={newFamilyBackground.guardian_family_name}
                  onChange={(e) =>
              ...
              <Box width="20%">
                ...
                <TextField
                  ...
                  style={{ width: "100%" }}
                  size="small"
                  value={newFamilyBackground.guardian_given_name}
                  onChange={(e) =>
              ...
              <Box width="20%">
                ...
                <TextField
                  ...
                  style={{ width: "100%" }}
                  size="small"
                  value={newFamilyBackground.guardian_middle_name}
                  onChange={(e) =>
              ...
              <Box width="20%">
                ...
                <TextField
                  ...
                  style={{ width: "100%" }}
                  size="small"
                  value={newFamilyBackground.guardian_nickname}
                  onChange={(e) =>
            ...
            <Box width="100%" marginTop="10px" display="flex" alignItems="center" gap={2}>
              ...
              <TextField
                ...
                fullWidth
                size="small"
                value={newFamilyBackground.guardian_email}
                onChange={(e) =>
            ...
            <Box display="flex" gap={2} width="100%" marginTop="10px">
              <Box width="48%" display="flex" alignItems="center" gap={1} style={{ marginRight: "50px" }}>
                ...
                <TextField
                  ...
                  size="small"
                  value={newFamilyBackground.guardian_contact}
                  onChange={(e) =>
          ...
          <FormControl fullWidth style={{ marginTop: '10px' }}>
            ...
            <Select
              ...
              value={newFamilyBackground.family_annual}
          ...
          <Box display="flex" justifyContent="space-between" mt={4}>
            ...
            <Button
              variant="contained"
              component={Link}
              to="/applicant" // The path where the button will link to
