...
import {
  ...
  Container,
  Typography,
  FormControl, InputLabel, Select, MenuItem, ListSubheader, Avatar, Modal
...
const ApplicantForm = () => {
  ...
  // State for editing applicant ID
    ...
    <Container>
      ...
      <form>
        <Container maxWidth="100%" sx={{ backgroundColor: "#6D2323", color: "white", borderRadius: 2, boxShadow: 3, padding: "4px", }}>
          <Box sx={{ width: "100%", }}>
            <Typography style={{ fontSize: "15px", padding: "10px", }}>Step 1: Personal Information</Typography>
          </Box>
        </Container>
